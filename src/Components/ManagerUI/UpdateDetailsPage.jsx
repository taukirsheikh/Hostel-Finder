...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await axios.patch(`http://127.0.0.1:8000/api/update-single-hostel/${hid}/`, hostelUpdate,{headers:{
            ...
            <div className="hostel-image">
              <div className="hostel-image-items">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setHostelUpdate({ ...hostelUpdate, image_1: e.target.files[0] })
                  }
                ></input>
                <br />
              </div>
              ...
              <div className="hostel-image-items">
                ...
                <input
                  ...
                  name="image_2"
                  onChange={(e) =>
                    setHostelUpdate({ ...hostelUpdate, image_2: e.target.files[0] })}
              ...
              <div className="hostel-image-items">
                ...
                <input
                  ...
                  name="image_3"
                  onChange={(e) =>
                    setHostelUpdate({ ...hostelUpdate, image_3: e.target.files[0] })}
